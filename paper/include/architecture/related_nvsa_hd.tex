...
the Region: rather than encoding all information into a single
high-dimensional vector, the system distributes content across many
frames that interact through boolean operations.
...
execution pipeline reduces to SIMD bitwise operations with no
data-dependent branching, making it portable across any hardware that
supports population count and integer comparison.
