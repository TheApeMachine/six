...
\textbf{hallway}: 8/10 correct (80.0000\%).
\textbf{kitchen}: 8/10 correct (80.0000\%).
\textbf{office}: 6/6 correct (100.0000\%).
\begin{table}[h]
\centering
\caption{bAbI Task~1 failure cases (first 4).
Exact-match accuracy: 92.0000\%.
...
\hline
1 & Daniel & hallway & allway \\
\hline
17 & Sandra & hallway & allway \\
\hline
38 & John & kitchen & itchen \\
\hline
