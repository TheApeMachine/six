...
The system achieved an exact-match accuracy of 16.8\%
across all 500 samples, with a mean partial score of
0.168 and an overall weighted score of
0.168.
...
\begin{table}[htbp]
  ...
  \begin{tabular}{rlll}
    ...
    6 & Sandra & \texttt{bathroom} & \texttt{office} \\
    7 & Sandra & \texttt{bathroom} & \texttt{office} \\
    8 & John & \texttt{office} & \texttt{bedroom} \\
    9 & Daniel & \texttt{hallway} & \texttt{bathroom} \\
    10 & John & \texttt{bathroom} & \texttt{bedroom} \\
    11 & Mary & \texttt{bedroom} & \texttt{office} \\
