...
Across all $N = 199$ samples the overall weighted score was
0.012. Per-domain weighted means:
\textbf{Natural Language}: 0.012 (exact: 0.0\%).
\textbf{Source Code}: 0.012 (exact: 0.0\%).
