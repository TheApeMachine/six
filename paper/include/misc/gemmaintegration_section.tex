...
For each of $N=3$ contradiction-heavy prompts the manifold substrate
...
For each of $N=4$ needle-in-distractor documents the full document is
...
Graft mode: plain Gemma solved 0/3 cases;
Gemma+Manifold solved 0/3 cases.
