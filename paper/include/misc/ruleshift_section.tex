...
\begin{itemize}[nosep]
  \item \textbf{Rule A} (steps 0--1, $N=25$ samples):
        linear modular sequences, $b_k = (s_i + 3k) \bmod 251$.
  \item \textbf{Rule B} (steps 1--2, $N=25$ samples):
...
trajectory.  The shift boundary is at step 1.  Rule B
did not stabilise within the observation window.  Phase A had $1$ of
$2$ steps won by Rule A
(50\,\%); Phase B had $0$ of
