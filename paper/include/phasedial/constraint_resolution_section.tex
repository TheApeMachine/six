...
Mean final alignment with target (MAID): 0.131.
Mean final alignment averaged across all suspects: 0.033.
Target isolation ratio: 4.000.
...
Figure~\ref{fig:constraint_resolution} shows the trial outcome map.
