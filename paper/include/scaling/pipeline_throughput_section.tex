...
Per-query latency declines across the sequence (mean 0.0\,ms,
range [0.0,\,1.0]\,ms). Beam confidence: $$\mu = 0.000$, $\sigma = 0.000$, median $= 0.000$, range $[0.000,\,0.000]$, $N = 0$$.
...
Latency decreases over the sequence (mean 0.0\,ms)—cache warming
