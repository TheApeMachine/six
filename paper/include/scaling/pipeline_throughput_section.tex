...
range [0.0,\,0.0]\,ms). Beam confidence: $$\mu = 0.000$, $\sigma = 0.000$, median $= 0.000$, range $[0.000,\,0.000]$, $N = 0$$.
...
Latency stays flat across the query sequence (mean 0.0\,ms,
$\sigma = 0.0$\,ms) with low rejection ($0.000$). The pipeline
