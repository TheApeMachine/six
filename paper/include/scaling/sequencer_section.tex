...
\paragraph{Results.}
Beam confidence rises across 50 queries (top-score $$\mu = -2.983$, $\sigma = 3.407$, median $= -3.466$, range $[-21.438,\,0.000]$, $N = 50$$).
...
Beam confidence: $$\mu = -2.983$, $\sigma = 3.407$, median $= -3.466$, range $[-21.438,\,0.000]$, $N = 50$$ (trend: rises). Rejection: $0.018$.
