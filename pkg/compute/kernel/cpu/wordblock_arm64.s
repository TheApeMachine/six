...
// pkg/compute/programmer.OperationType): four-character binary strings with
// LSB = rightmost digit. Bit k enables minterm k when masks are 0 or ~0:
//   op&1 → m0 / (a ∧ b)
//   op&2 → m1 / (a ∧ ¬b)
//   op&4 → m2 / (¬a ∧ b)
//   op&8 → m3 / (¬a ∧ ¬b)
// Result is (a∧b∧m0)|(a∧¬b∧m1)|(¬a∧b∧m2)|(¬a∧¬b∧m3); dst packing matches the
// Go kernel. Sixteen rotation groups × four lanes = 64 elements
// (value.num_rotations is 16).
//
