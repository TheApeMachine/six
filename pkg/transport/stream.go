...
// /*
// Stream is a concurrent, Affinity-aware data stream with
// optional TTL and region-based routing. It is currently
// simplified, because of the new non-folding execution
// model of Values, there is less of a requirement to keep
// the Values moving.
// */
// type Stream struct {
// 	ctx         context.Context
