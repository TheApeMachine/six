...
} from "../node-graph/components/TimeSlider";
import type { TimeRange } from "./NodeGraphLegacy";

interface NodeGraphLegacyTimeControlsProps {
	showTimeSlider: boolean;
	timeRange: TimeRange;
	onTimeChange: (from: number, to: number) => void;
	onPlaybackChange: (isPlaying: boolean, isRepeating: boolean, isExpanded: boolean) => void;
